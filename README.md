...
|     C6, C8-C11, C15-C18              |     10uF                                  |     9       |     電解コンデンサ。2mmピッチ                                                                                                   |     P-04621, P-04624 など       |
...
|     R6 - R9                          |     10K                                   |     4       |     R6とR7は基板上に20Kとありますが、10K以下を使ってください                                                                    |     R-25103, R-16877               |
|     R4, R5                           |     20K                                   |     2       |     抵抗。                                                                                                                      |                                      |
|     R1, R11                          |     2K                                    |     2       |     抵抗。                                                                                                                      |                                      |
|     R12                              |     330                                   |     1       |     抵抗。                                                                                                                      |                                      |
|     R13                              |     620                                   |     1       |     抵抗。                                                                                                                      |                                      |
...
|     RV1, RV2                         |     ボリューム   10ｋΩＡ                  |     2       |     音量用ボリューム。   ALPS ALPINE製 RK09D117000C                                                                             |     P-14773                          |
...
|                                      |     細ピンヘッダ 1x40                     |     1       |     マイコン用ピンヘッダ                                                                                                        |     C-06631                          |
|                                      |     丸ピンIC用   ソケット 1x40            |     1       |     マイコン用ソケット                                                                                                          |     P-01591                          |
|     U2                               |     4回路オペアンプ                       |     1       |     速めのオペアンプなら大抵動くはず   LMC6484AIN, TLC274BCN,     LME49740NA, NJM2747D など                                     |     I-03685, I-09117 など       |
